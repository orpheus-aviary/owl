...
## 当前阶段：P3.4 UX 完善（开工前规划，2026-05-04）

461/461 测试通过。上阶段 P3.3 0.3.0 已 ship（GUI `v0.3.0` + CLI `cli-v0.3.0` 独立渠道同日发布）。
...
子项 scope 详情见 `docs/plans/2026-04-20-p3-plan.md` §7。

### 下一步

开 P3.4-a 的 design doc：`docs/plans/YYYY-MM-DD-p3-4-a-sorting-model-design.md`。每个子项动工前单独开 design doc（沿用 P3.2-a/b/c/d 命名），不再开总 plan 文件。
